...
func (s *Skein) Sum(b []byte, hash []byte) {
	s.finalIntern(hash)
}
...
// New initializes the Skein hash instance.
//
// stateSize
...
// NewExtended initializes the Skein hash instance for use with a key and tree.
//
// stateSize
...
// UpdateBits updates the hash with a message bit string.
//
...
// DoFinal finalizes a Skein digest and returns the hash.
//
